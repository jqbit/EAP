...
def main():
    ...
    # Glob mode: repo_root/tests/eap-signal-compress/
    # __file__ lives at <repo_root>/skills/eap-signal-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → eap-signal-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "eap-signal-compress"
