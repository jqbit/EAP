...
> Adapted for **EAP-Lean** from ponytail's platform-native catalog
> (MIT, © Dietrich Gebert — see `../../../docs/legal/ATTRIBUTION.md`).
> The Native rung of the decision ladder: scan here before adding a dependency.
...
```js
// eap-lean: 3 lines beats a dependency
let t;
