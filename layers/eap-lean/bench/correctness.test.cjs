// Regression guard for the correctness gate (upstream gate fixes carried over). Run: node correctness.test.cjs
// Needs python + node on PATH, same as correctness.cjs itself.
const assert = require('assert');
const check = require('./correctness.cjs');
